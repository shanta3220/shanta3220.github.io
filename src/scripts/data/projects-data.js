export const projectsData = [
  ...
  Integrates gaming with social features like leaderboards and profiles.
  Provides a convenient, lightweight platform for a seamless gaming experience.`,
    skills: [
      "React.js",
      "JavaScript",
      "Sass",
  ...
  Features real-time inventory tracking, order management, and detailed reporting.
  Simplifies inventory processes, reduces manual errors, and supports optimal stock levels.`,
    skills: [
      "JavaScript",
      "Vite",
      "React.js",
