  ...
  return (
    <section className="home">
      <div className="hero">
        ...
        <motion.p className="hero__paragraph" {...getTransition(0.5)}>
          A passionate software engineer and game developer with a deep
          curiosity for how technology can shape our lives.
        </motion.p>
        <motion.p className="hero__paragraph" {...getTransition(0.7)}>
        ...
        <motion.p className="hero__paragraph" {...getTransition(0.9)}>
